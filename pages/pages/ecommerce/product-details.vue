                                ...
                                <div class="col-xxl-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-md-5 mb-3">
                                    <swiper :style="{
                                        ...
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/ecommerce/png/15.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/ecommerce/png/13.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/ecommerce/png/14.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/ecommerce/png/17.png" /></swiper-slide>
                                    </swiper>
                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/ecommerce/png/16.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fs-14 fw-semibold similar-product-name text-truncate">
                                                                        Omega watch series 3</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">4.4<i
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/ecommerce/png/17.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fs-14 fw-semibold similar-product-name text-truncate">
                                                                        Strap on watch(White)</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">3.8<i
                                                                                class="ri-star-s-fill ms-1"></i></span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/ecommerce/png/18.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fw-semibold similar-product-name text-truncate">
                                                                        Orange watch series 3</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">4.1<i
                                                                                class="ri-star-s-fill ms-1"></i></span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/ecommerce/png/19.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fw-semibold similar-product-name text-truncate">
                                                                        Omega watch special edition</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">3.8<i
                                                                                class="ri-star-s-fill ms-1"></i></span>
                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fw-semibold similar-product-name text-truncate">
                                                                        Fassil smart watch(45mm)</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">4.5<i
                                                                                class="ri-star-s-fill ms-1"></i></span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/ecommerce/png/22.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fw-semibold similar-product-name text-truncate">
                                                                        Bolts smart watch(Amoled)</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">4.3<i
                                                                                class="ri-star-s-fill ms-1"></i></span>
                                                        ...
                                                        <table class="table table-bordered text-nowrap">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        Heart rate sensor,GPS,Wifi calling,SAmoled display
                                                                        e.t.c
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="mb-0 fs-12 lh-lg">Sold by <span class="text-primary me-1"><u>Regaltos
                                                    ...
                                                    class="text-primary"><u>Spruko Tchnologies</u>.</span></p>
                                        </div>
                                        <div class="mb-4">
                                            <ul class="list-group">
                                        ...
                                        <div class="alert alert-light mb-4 fs-12 text-muted" role="alert">
                                            <a href="javascript:void(0);"><i
                                                    class="ri-map-pin-line me-1 align-middle text-primary fs-15"></i></a>Select
                                            location to find out estimated delivery date
                                        </div>
                                        <div class="d-grid">
                                            <NuxtLink to="/pages/ecommerce/cart" class="btn btn-primary mb-2">Add To Cart
                                            </NuxtLink>
                                            <NuxtLink to="/pages/ecommerce/checkout" class="btn btn-success mb-2">Buy Now
                                            </NuxtLink>
                                            <NuxtLink to="/pages/ecommerce/wishlist" class="btn btn-light">Add To Wishlist
                                            </NuxtLink>
                                        </div>
                                    </div>
                                    <div class="text-center">
