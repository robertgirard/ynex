        ...
        <div class="main-content landing-main px-0">
                        ...
                        <div class="row">
                            <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8">
                                <div class="py-lg-5">
                                    ...
                                    <div class="fs-16 mb-5 text-fixed-white op-7">ynex - Now you can use this admin template
                                        to
                                        design stunning dashboards that will wow your target viewers or users to no end.
                                    </div>
                                    <NuxtLink to='/' class="m-1 btn btn-primary">
                                        View Demos
            ...
            <section class="section " id="about">
                <div class="container text-center">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-7">
                            <p class="text-muted fs-15 mb-3 fw-normal">ynex comes with multiple customization options that
                                are
                                very
                                easy to implement.</p>
                        </div>
                    ...
                    <div class="row justify-content-between align-items-center mx-0">
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 pt-5 pb-0 px-lg-2 px-5 text-start">
                            ...
                            <p class=" text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen or damsenlel
                                verman
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="fw-semibold mb-0">Can Switch Easily From Vertical to HorizontalMenu.
                                            </h6>
                                            <p class=" text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen
                                                or
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="fw-semibold mb-0">Switch Easily From One Color to Another Color style
                                            </h6>
                                            <p class=" text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen
                                                or
                                                damsenlel verman code Lorem ipsum, dolor sit amet consectetur </p>
                                ...
                                <div class="card-body">
                                    <div class="align-items-top">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel
                                                varen
                                                or
                                                damsenlel verman code Lorem ipsum, dolor sit amet consectetur adipisicing
                                                elit
                                            </p>
                                        </div>
                                    </div>
            ...
            <section class="section landing-Features" id="features">
                <div class="container text-center">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-7">
                            <p class="text-fixed-white op-8 fs-15 mb-3 fw-normal">Some of the reviews our clients gave which
                                brings
                        ...
                        <div class="justify-content-center">
                            <div class="">
                                <div class="feature-logos mt-sm-5 flex-wrap">
                                    ...
                                    <div class="ms-sm-5 ms-2 text-center">
                                        <img src="/images/media/landing/web/nuxt.png" alt="image" class="featur-icon">
                                        <h5 class="mt-3 text-fixed-white ">Nuxt3</h5>
                                    </div>
                                    <div class="ms-sm-5 ms-2 text-center">
                                    ...
                                    <div class="ms-sm-5 ms-2 text-center">
                                        <img src="/images/media/landing/web/pinia.svg" alt="image" class="featur-icon">
            ...
            <section class="section  section-bg" id="team">
                <div class="container text-center">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-7">
                            <p class="text-muted fs-15 mb-5 fw-normal">Our team consists of highly qulified employees that
                                works
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card text-center team-card ">
                                <div class="card-body p-5">
                                    ...
                                    <p class="text-muted mt-2 fs-13"> Lorem ipsum dolor sit amet, consectetur adipisicing
                                        elit.
                                    </p>
                                    <div class="mt-2">
                                        <NuxtLink to="/pages/profile" class="btn btn-light" target="_blank">View profile
                                        </NuxtLink>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="section  " id="pricing">
                <div class="container text-center">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-9">
                            <p class="text-muted fs-15 mb-5 fw-normal">Our plans are most affordable and are mainly placed
                                by
                        ...
                        <div class="col-md-4 col-sm-6 col-12 mb-md-0 mb-3">
                            <div class="px-4">
                                <p class="fw-semibold mb-3">
                                    <NuxtLink to='/'><img src="/images/brand-logos/desktop-dark.png" alt=""></NuxtLink>
                                </p>
